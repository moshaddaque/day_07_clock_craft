...
class AnalogClockGallery extends StatelessWidget {
  const AnalogClockGallery({super.key});
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final clock = analogClocks[index];
            return Padding(
                    ...
                    Expanded(
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: AnalogClockWidget(clock: clock),
                        ),
                      ),
                    ),
                    Container(
